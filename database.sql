...
CREATE TABLE IF NOT EXISTS `ORDER` (
  ...
  `BUYER_SKEY` int unsigned NOT NULL,
  PRIMARY KEY('SKEY'),
  UNIQUE KEY `ORDER_ID_UNIQUE` (`ORDER_ID`),
  FOREIGN KEY(`BUYER_SKEY`) REFERENCES BUYERINFO(`SKEY`) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `ORDER_INFO` (
  ...
  `SELLER_ID` int unsigned NOT NULL,
  PRIMARY KEY('SKEY'),
  CONSTRAINT ORDER_QTY_CHK CHECK (ORDER_QTY > 0),
...
CREATE TABLE IF NOT EXISTS `CART_INFO` (
  ...
  `SELLER_ID` int unsigned NOT NULL,
  PRIMARY KEY('SKEY'),
  CONSTRAINT CART_QTY_CHK CHECK (CART_QTY > 0),
